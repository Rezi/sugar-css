...
<article>
	...
	<h3>Light theme</h3>
	<CardCode examplePosition="top" card={false} code={lightCardCode}></CardCode>
	<h3>Dark theme</h3>
	<CardCode examplePosition="top" card={false} code={darkCardCode}></CardCode>
</article>
